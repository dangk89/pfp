...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    int time_runs;
    struct futhark_i32_2d *result_4068;
    
    if (perform_warmup) {
        time_runs = 0;
        assert(futhark_context_sync(ctx) == 0);
        t_start = get_wall_time();
        assert(futhark_main(ctx, &result_4068) == 0);
        assert(futhark_context_sync(ctx) == 0);
        t_end = get_wall_time();
        ...
        assert(futhark_free_i32_2d(ctx, result_4068) == 0);
    }
    time_runs = 1;
    /* Proper run. */
    ...
    }
    {
        int32_t *arr = calloc(sizeof(int32_t), futhark_shape_i32_2d(ctx,
                                                                    result_4068)[0] *
                              futhark_shape_i32_2d(ctx, result_4068)[1]);
        
        assert(arr != NULL);
        assert(futhark_values_i32_2d(ctx, result_4068, arr) == 0);
...
{
    int32_t out_memsizze_4061;
    struct memblock out_mem_4060;
    
    out_mem_4060.references = NULL;
    
    int32_t out_arrsizze_4062;
    int32_t out_arrsizze_4063;
    struct memblock mem_4059;
    
    mem_4059.references = NULL;
    memblock_alloc(ctx, &mem_4059, 8400);
    for (int32_t i_4064 = 0; i_4064 < 2100; i_4064++) {
        *(int32_t *) &mem_4059.mem[i_4064 * 4] = 0;
    }
    for (int32_t write_iter_4048 = 0; write_iter_4048 < 40; write_iter_4048++) {
        int32_t res_4043 = 1 + write_iter_4048;
        int32_t res_4044 = 70 + res_4043;
        
        *(int32_t *) &mem_4059.mem[res_4044 * 4] = 1;
    }
    out_arrsizze_4062 = 30;
    out_arrsizze_4063 = 70;
    out_memsizze_4061 = 8400;
    memblock_set(ctx, &out_mem_4060, &mem_4059);
    
    struct futrts_int32_t_mem_int32_t_int32_t retval_4066;
    
    retval_4066.v0 = out_memsizze_4061;
    retval_4066.v1.references = NULL;
    memblock_set(ctx, &retval_4066.v1, &out_mem_4060);
    retval_4066.v2 = out_arrsizze_4062;
    retval_4066.v3 = out_arrsizze_4063;
    memblock_unref(ctx, &out_mem_4060);
    memblock_unref(ctx, &mem_4059);
    return retval_4066;
}
struct futhark_i32_2d {
    struct memblock mem;
...
int futhark_main(struct futhark_context *ctx, struct futhark_i32_2d **out0)
{
    ...
    int32_t out_arrsizze_4062;
    int32_t out_arrsizze_4063;
    struct futrts_int32_t_mem_int32_t_int32_t ret_4067;
    
    ret_4067 = futrts_main(ctx);
    out_memsizze_4061 = ret_4067.v0;
    out_mem_4060 = ret_4067.v1;
    out_arrsizze_4062 = ret_4067.v2;
    out_arrsizze_4063 = ret_4067.v3;
    assert((*out0 = malloc(sizeof(struct futhark_i32_2d))) != NULL);
    (*out0)->mem = out_mem_4060;
    (*out0)->shape[0] = out_arrsizze_4062;
    (*out0)->shape[1] = out_arrsizze_4063;
    return 0;
}
