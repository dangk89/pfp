...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    if (perform_warmup) {
        ...
        assert(futhark_main(ctx, &result_3120, &result_3121) == 0);
        assert(futhark_context_sync(ctx) == 0);
        t_end = get_wall_time();
    ...
    write_scalar(stdout, binary_output, &i32, &result_3120);
    printf("\n");
    write_scalar(stdout, binary_output, &i32, &result_3121);
    printf("\n");
    ;
    ;
}
...
static struct futrts_int32_t_int32_t futrts_main(struct futhark_context *ctx)
{
    int32_t scalar_out_3116;
    int32_t scalar_out_3117;
    
    scalar_out_3116 = -15;
    scalar_out_3117 = 59;
    
    struct futrts_int32_t_int32_t retval_3118;
    
    retval_3118.v0 = scalar_out_3116;
    retval_3118.v1 = scalar_out_3117;
    return retval_3118;
}
int futhark_main(struct futhark_context *ctx, int32_t *out0, int32_t *out1)
{
    int32_t scalar_out_3116;
    int32_t scalar_out_3117;
    struct futrts_int32_t_int32_t ret_3119;
    
    ret_3119 = futrts_main(ctx);
    scalar_out_3116 = ret_3119.v0;
    scalar_out_3117 = ret_3119.v1;
    *out0 = scalar_out_3116;
    *out1 = scalar_out_3117;
    return 0;
}
