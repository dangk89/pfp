...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    int time_runs;
    struct futhark_i32_1d *read_value_3319;
    int64_t read_shape_3320[1];
    int32_t *read_arr_3321 = NULL;
    
    errno = 0;
    if (read_array(&i32, (void **) &read_arr_3321, read_shape_3320, 1) != 0)
        panic(1, "Failed reading input of type %s%s (errno: %s).\n", "[]",
              i32.type_name, strerror(errno));
    
    struct futhark_i32_1d *read_value_3322;
    int64_t read_shape_3323[1];
    int32_t *read_arr_3324 = NULL;
    
    errno = 0;
    if (read_array(&i32, (void **) &read_arr_3324, read_shape_3323, 1) != 0)
        panic(1, "Failed reading input of type %s%s (errno: %s).\n", "[]",
              i32.type_name, strerror(errno));
    ...
    if (perform_warmup) {
        time_runs = 0;
        assert((read_value_3319 = futhark_new_i32_1d(ctx, read_arr_3321,
                                                     read_shape_3320[0])) != 0);
        assert((read_value_3322 = futhark_new_i32_1d(ctx, read_arr_3324,
                                                     read_shape_3323[0])) != 0);
        assert(futhark_context_sync(ctx) == 0);
        t_start = get_wall_time();
        assert(futhark_main(ctx, &result_3325, &result_3326, read_value_3319,
                            read_value_3322) == 0);
        assert(futhark_context_sync(ctx) == 0);
        t_end = get_wall_time();
        ...
        assert(futhark_free_i32_1d(ctx, read_value_3319) == 0);
        assert(futhark_free_i32_1d(ctx, read_value_3322) == 0);
        ;
        ;
    }
    time_runs = 1;
    ...
    free(read_arr_3321);
    free(read_arr_3324);
    write_scalar(stdout, binary_output, &i32, &result_3325);
    printf("\n");
    write_scalar(stdout, binary_output, &i32, &result_3326);
    printf("\n");
    ;
    ;
}
...
static struct futrts_int32_t_int32_t futrts_main(struct futhark_context *ctx,
                                                 int64_t xs_mem_sizze_3309,
                                                 struct memblock xs_mem_3310,
                                                 int64_t ys_mem_sizze_3311,
                                                 struct memblock ys_mem_3312,
                                                 int32_t sizze_3261,
                                                 int32_t sizze_3262);
...
static struct futrts_int32_t_int32_t futrts_main(struct futhark_context *ctx,
                                                 ...
                                                 int32_t sizze_3262)
{
    int32_t scalar_out_3313;
    int32_t scalar_out_3314;
    ...
    acc_3303 = 0;
    acc_3304 = -1;
    for (int32_t i_3302 = 0; i_3302 < sizze_3261; i_3302++) {
        int32_t binop_param_x_3288 = *(int32_t *) &xs_mem_3310.mem[i_3302 * 4];
        int32_t binop_param_y_3289 = *(int32_t *) &ys_mem_3312.mem[i_3302 * 4];
        int32_t res_3291 = binop_param_x_3288 - binop_param_y_3289;
        int32_t res_3292 = abs(res_3291);
        char cond_3293 = slt32(res_3292, acc_3303);
        int32_t res_3294;
        ...
        int32_t acc_tmp_3315 = res_3294;
        int32_t acc_tmp_3316;
        
        acc_tmp_3316 = res_3295;
        acc_3303 = acc_tmp_3315;
        acc_3304 = acc_tmp_3316;
    }
    res_3277 = acc_3303;
    res_3278 = acc_3304;
    scalar_out_3313 = res_3277;
    scalar_out_3314 = res_3278;
    
    struct futrts_int32_t_int32_t retval_3317;
    
    retval_3317.v0 = scalar_out_3313;
    retval_3317.v1 = scalar_out_3314;
    return retval_3317;
}
struct futhark_i32_1d {
    struct memblock mem;
                 ...
                 struct futhark_i32_1d *in0, struct futhark_i32_1d *in1)
{
    ...
    xs_mem_3310.references = NULL;
    
    int64_t ys_mem_sizze_3311;
    struct memblock ys_mem_3312;
    
    ys_mem_3312.references = NULL;
    ...
    xs_mem_3310 = in0->mem;
    xs_mem_sizze_3309 = in0->mem.size;
    sizze_3261 = in0->shape[0];
    ys_mem_3312 = in1->mem;
    ys_mem_sizze_3311 = in1->mem.size;
    sizze_3262 = in1->shape[0];
    
    struct futrts_int32_t_int32_t ret_3318;
    
    ret_3318 = futrts_main(ctx, xs_mem_sizze_3309, xs_mem_3310,
                           ys_mem_sizze_3311, ys_mem_3312, sizze_3261,
                           sizze_3262);
    scalar_out_3313 = ret_3318.v0;
    scalar_out_3314 = ret_3318.v1;
    *out0 = scalar_out_3313;
    *out1 = scalar_out_3314;
    return 0;
}
